...
export const calendarEvents = [
  {
    ...
    end: new Date(2025, 5, 5, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 5, 5, 9, 0),
    end: new Date(2025, 5, 5, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 5, 5, 10, 0),
    end: new Date(2025, 5, 5, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 5, 5, 11, 0),
    end: new Date(2025, 5, 5, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 5, 5, 13, 0),
    end: new Date(2025, 5, 5, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 5, 5, 14, 0),
    end: new Date(2025, 5, 5, 14, 45),
  },
  {
    title: "English",
    allDay: false,
